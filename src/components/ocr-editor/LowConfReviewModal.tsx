        ...
        <div className="px-4 py-3 space-y-3">
          ...
          <div className="flex items-center gap-4">
            <div className="text-center">
              <span className="text-4xl font-serif leading-none">{current.text}</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 px-2 py-1 text-lg font-serif text-center border border-gray-300 rounded focus:outline-none focus:border-indigo-400"
            />
          </div>
              ...
              <div className="flex flex-wrap gap-1">
                {current.choices.map((alt, i) => (
                  <button
                    ...
                    className="w-10 h-10 text-lg font-serif rounded border border-gray-200 hover:border-indigo-400 hover:bg-indigo-50 transition-colors"
                  >
                    {alt}
                  </button>
                ))}
