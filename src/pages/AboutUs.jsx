  ...
  return (
    <div className="flex flex-col items-center max-width">
      <div className="flex-col mb-20 mx-5">
        ...
        <h2>{i18n.language === "en" ? "Our Mission" : "Sứ mệnh"}</h2>
        ...
        <h2>{i18n.language === "en" ? "Core Team" : "Nhóm vận hành chính"}</h2>
        ...
        <div className="flex flex-wrap justify-start items-start md:flex-row flex-col">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center mb-5">
            ...
            />
            <h3 className="text-xl">
              {i18n.language === "en" ? "Phuc Hoang Le" : "Lê Hoàng Phúc"}
            </h3>
            <p className="px-5">
              {i18n.language === "en"
        ...
        <h2>{i18n.language === "en" ? "Advisors" : "Cố vấn"}</h2>
        <div className="flex flex-wrap justify-start items-start md:flex-row flex-col">
          <div className="w-full md:w-1/4 flex flex-col items-center mb-5">
            ...
            />
            <h3 className="text-xl">
              {i18n.language === "en" ? "Hoang Minh Vu" : "Vũ Minh Hoàng"}
            </h3>
            <p className="px-5">
              {i18n.language === "en"
                ? "Ph.D. in History"
          ...
          <div className="w-full md:w-1/4 flex flex-col items-center mb-5">
            ...
            />
            <h3 className="text-xl">
              {i18n.language === "en" ? "John Phan" : "John Phan"}
            </h3>
            <p className="px-5">
              {i18n.language === "en"
          ...
          <div className="w-full md:w-1/4 flex flex-col items-center mb-5">
            ...
            />
            <h3 className="text-xl">
              {i18n.language === "en" ? "Lien-Hang Nguyen" : "Lien-Hang Nguyen"}
            </h3>
            <p className="px-5">
              {i18n.language === "en" ? "Ph.D. in History" : "Tiến sĩ Lịch sử"}
            </p>
            <p className="px-5">
              {i18n.language === "en"
          ...
          <div className="w-full md:w-1/4 flex flex-col items-center mb-5">
            ...
            />
            <h3 className="text-xl">
              {i18n.language === "en" ? "Nam Nguyen" : "Nguyễn Nam"}
            </h3>
            <p className="px-5">
              {i18n.language === "en"
        ...
        <h2>
          {i18n.language === "en" ? "Institutional Support" : "Đơn vị hỗ trợ"}
        </h2>
        ...
        <h2>{i18n.language === "en" ? "Funding" : "Nguồn tài trợ"}</h2>
        <p className="mb-5">
          {i18n.language === "en"
          ...
          {i18n.language === "en" ? "grant from the" : "từ Quỹ"}{" "}
          <a
        ...
        <h2>{i18n.language === "en" ? "Our Collections" : "Bộ sưu tập"}</h2>
        <p className="mb-5">
          {i18n.language === "en"
