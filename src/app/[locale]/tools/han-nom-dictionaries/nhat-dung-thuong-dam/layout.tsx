        ...
        <aside className="w-full lg:w-96 shrink-0 font-light font-['Helvetica Neue']">
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            <nav className="flex flex-col">
              <NavLink href="/tools/han-nom-dictionaries/nhat-dung-thuong-dam/preface">
                {locale === "en" ? "Preface" : "Lời dẫn"}
              </NavLink>
              <NavLink href="/tools/han-nom-dictionaries/nhat-dung-thuong-dam/table-of-contents">
                {locale === "en" ? "Table of Contents" : "Mục lục từ điển"}
              </NavLink>
              <NavLink href="/tools/han-nom-dictionaries/nhat-dung-thuong-dam">
