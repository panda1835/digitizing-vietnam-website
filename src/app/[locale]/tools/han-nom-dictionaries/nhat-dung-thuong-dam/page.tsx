...
export default async function DictionaryPage({
  ...
  if (searchWord) {
    ...
    const entries = await fetch(
      `${apiUrl}/han-nom-dictionary/nhat-dung-thuong-dam?q=${searchWord}`
    );
  ...
  return (
    <div className="">
      ...
      <div className={`font-['Helvetica_Neue'] font-light text-base my-6`}>
        <span>
          {t(
            "Tools.han-nom-dictionaries.dictionaries.nhat-dung-thuong-dam.author"
          )}
        </span>
      </div>
      <div className="mx-auto">
        <div className="flex gap-4 mb-6 items-center">
          <DictionarySearchBar
            ...
            placeholder={t(
              "Tools.han-nom-dictionaries.dictionaries.nhat-dung-thuong-dam.search-placeholder"
            )}
          />
        </div>
      </div>
